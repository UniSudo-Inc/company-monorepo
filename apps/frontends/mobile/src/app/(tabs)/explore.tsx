...
import { Image, Platform, StyleSheet, type ImageRequireSource } from 'react-native';
  ...
  return (
    ...
    >
      ...
      <Collapsible title='Images'>
        ...
        <Image source={require('../../../assets/images/react-logo.png') as ImageRequireSource} style={styles.logoImage} />
      ...
      <Collapsible title='Custom fonts'>
        <ThemedText>
          ...
          <ThemedText style={styles.customFontText}>custom fonts such as this one.</ThemedText>
        </ThemedText>
